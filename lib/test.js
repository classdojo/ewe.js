  ...
  Test = (function() {
    ...
    */
    ...
    Test.prototype.select = function() {
      ...
      variantIndex = utils.getRandomIndex(this.group.key + this.name, this._variants.length, this.weights());
    ...
    */
    ...
    Test.prototype.start = function() {
      this.ewe.service.start(this._selected = this.select());
    ...
    */
    ...
    Test.prototype.complete = function() {
      ...
      return this.ewe.service.complete(this._selected);
    };
